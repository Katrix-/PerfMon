...
lazy val commonSettings = Seq(
  name := s"PerfMon-${removeSnapshot(spongeApiVersion.value)}",
  ...
  spongePluginInfo := spongePluginInfo.value.copy(
    ...
    authors = Seq("Katrix"),
    description = Some("A plugin to help manage performance"),
    dependencies = Set(
...
lazy val perfMonShared = (project in file("shared"))
